...
public class Main{		//variables pour menhir et graine dans le main ou dans cartes????
        public static void main (String[] args){
          ...
          /*  int nbrJoueur , nbrJoueurOrdi, typePartie, nbrJoueurReel ;
            ...
            System.out.println("Voulez vous faire une partie rapide ou une partie avanc�e ? ");
            typePartie = FonctionScan.recuperEntierEntrerCla("taper 1 pour faire une partie rapide et 2 pour faire une partie avanc�e");
            ...
            while (nbrJoueur <= 1 || nbrJoueur > 8){
                nbrJoueur = FonctionScan.recuperEntierEntrerCla("Nombre de joueur participant ? :( doit �tre inferieur � 8 et sup�rieur � 1)");
            }
